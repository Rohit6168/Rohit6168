...
I'm a passionate **Full Stack Developer** specializing in building modern web applications using **React**, **Spring Boot**, and cloud technologies. I love creating scalable, secure, and user-friendly applications that solve real-world problems.

- 🔭 Currently working on full-stack projects with **React** & **Spring Boot**
- 🌱 Learning advanced **Cloud Architecture** and **Microservices**
- 💡 Interested in **FinTech**, **Blockchain**, and **AI/ML**
- 🎯 Goal: Building impactful products that make a difference
- 💬 Ask me about **React**, **Spring Boot**, **REST APIs**, **Payment Integration**
...
[![Live Demo](https://img.shields.io/badge/Live_Demo-Visit-success?style=flat-square)](https://rohit-xchange-frontend.vercel.app/)
[![GitHub](https://img.shields.io/badge/GitHub-View_Code-181717?style=flat-square&logo=github)](https://github.com/Rohit6168/RohitXchangeFrontend)

A full-stack cryptocurrency exchange platform with real-time market data, secure wallet management, and AI-powered chatbot assistance.

**🔧 Tech Stack:** React, Spring Boot, MySQL, Razorpay, Stripe, JWT, Recharts

**✨ Key Features:**
- 📊 Real-time crypto prices and interactive charts
- 💰 Digital wallet with Razorpay/Stripe integration
...
[![Live Demo](https://img.shields.io/badge/Live_Demo-Visit-success?style=flat-square)](https://moneymanagerfrontendd.netlify.app/)
[![GitHub](https://img.shields.io/badge/GitHub-View_Code-181717?style=flat-square&logo=github)](https://github.com/Rohit6168/money-manager-forntend)

A comprehensive personal finance management application to track income, expenses, and maintain financial health with visual analytics.

**🔧 Tech Stack:** React, Vite, Spring Boot, MySQL, Cloudinary, Apache POI, Recharts

**✨ Key Features:**
- 📧 Email verification with Cloudinary image upload
- 📊 Interactive income/expense charts
- 🎨 Custom categories with emoji icons
- 🔍 Advanced filtering and search
- 📥 Excel export and email reports
...
const rohit = {
    ...
    learning: ["Microservices", "Docker", "Kubernetes", "AWS"],
...
- 🎓 Built 2+ full-stack production-ready applications
- 💳 Integrated multiple payment gateways (Razorpay, Stripe)
- 🔐 Implemented JWT authentication & email verification systems
- ☁️ Successfully deployed applications on Vercel & Netlify
...
[![Rohit's github activity graph](https://github-readme-activity-graph.vercel.app/graph?username=Rohit6168&theme=tokyo-night&hide_border=true)](https://github.com/Rohit6168)
...
![Profile Views](https://komarev.com/ghpvc/?username=Rohit6168&color=blueviolet&style=for-the-badge&label=Profile+Views)
